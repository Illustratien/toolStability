...
test_that('coefficient_of_regression is same between function and table' ,{
  expect_equal(coefficient_of_regression(data,'trait','genotype','environment')$coefficient.of.regression,
...
test_that('deviation_mean_squares is same between function and table' ,{
  expect_equal(deviation_mean_squares(data,'trait','genotype','environment')$deviation.mean.squares,
...
test_that('coefficient_of_determination is same between function and table' ,{
  expect_equal(coefficient_of_determination(data,'trait','genotype','environment')$coefficient.of.determination,
...
test_that('genotypic_stability is same between function and table' ,{
  expect_equal(genotypic_stability(data,'trait','genotype','environment')$genotypic.stability,
...
test_that('mean_rank_difference is same between function and table' ,{
  expect_equal(mean_rank_difference(data,'trait','genotype','environment')$mean.rank.difference,
...
test_that('adjusted_coefficient_of_variation is same between function and table' ,{
  expect_equal(adjusted_coefficient_of_variation(data,'trait','genotype','environment')$adjusted.coefficient.of.variation,
...
test_that('genotypic_superiority_measure is same between function and table' ,{
  expect_equal(genotypic_superiority_measure(data,'trait','genotype','environment')$genotypic.superiority.measure,
...
test_that('safty_first_index is same between function and table' ,{
  expect_equal(safty_first_index(data,'trait','genotype','environment',lambda)$safty.first.index,
