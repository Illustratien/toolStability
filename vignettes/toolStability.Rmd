...
10^{(2-b)~ m_{i} +(b-2)~ \overline{m}+v_{i}} 
\right ] ^{0.5} \times 100 \% $$
...
$$ b_{i}=1 + \frac{\sum_{j}(X_{ij} -\overline{X_{i.}}-\overline{X_{.j}}+\overline{X_{..}}) ~
...
\sum_{j}~(X_{ij} - \overline{X_{i.}}- \overline{X_{.j}} + \overline{X_{..}}^{2}) - (b_{i} - 1)^{2} ~
...
Genotypic stability:
$$ D_{i}^{2} = \sum_{j}~(X_{ij} - \overline{X_{i.}}- b_{min}~ \overline{X_{.j}} + b_{min}~ \overline{X_{..}})^{2}$$
...
G ~(G-1)~ \sum_{j}~(X_{ij} - \overline{X_{i.}}-\overline{X_{.j}} + \overline{X_{..}})^{2}- \sum_{i} \sum_{j}~(X_{ij} - \overline{X_{i.}}-\overline{X_{.j}} + \overline{X_{..}})^{2}
\right ]
$$
where $X_{ij}$ is the observed phenotypic mean value of genotype $i$ (i = 1,..., G)
in environment $j$ (j = 1,...,E), with $\overline{X_{i.}}$ and $\overline{X_{.j}}$ 
