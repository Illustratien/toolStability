...
Under the linear model
$$Y =\mu + b_{i}\times e_{j} + g_{i} + d_{ij}$$
...
\sum_{j}(\overline{X_{.j}}-\overline{X_{..}})^{2} \right ]
$$
...
$$W_{i} = \frac{\sum_{j} (X_{ij} - \overline{X_{i.}}^{2})}{E-1}$$
where $X_{ij}$ is the observed phenotypic mean value of genotype $i$ (i = 1,..., G)
...
G \times(G-1)\times \sum_{j} (X_{ij} - \overline{X_{i.}}\times\overline{X_{.j}} + \overline{X_{..}})^{2}- \sum_{i} \sum_{j} (X_{ij} - \overline{X_{i.}}\times\overline{X_{.j}} + \overline{X_{..}})^{2}
\right ]
$$
where $X_{ij}$ is the observed phenotypic mean value of genotype $i$ (i = 1,..., G)
in environment $j$ (j = 1,...,E), with $\overline{X_{i.}}$ and $\overline{X_{.j}}$ 
